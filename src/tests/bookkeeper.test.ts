...
import { Logger } from "../bookkeeper.ts";
import { createConsoleWriter, createLogFileWriter } from "../node.ts";
import type { Log, LogWriter } from "../types/bookkeeper.d.ts";

describe("Logger", () => {
  it("should initialize with no constructor arguments", () => {
    const logger = new Logger();
  });

  it("should initialize with a given name", () => {
  ...
  describe("node:createConsoleWriter", () => {
  ...
  describe("node:createLogFileWriter", () => {
